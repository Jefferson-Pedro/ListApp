...
public class TelaCadastroTarefa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanelCorpoLayout.setVerticalGroup(
            ...
            .addGroup(jPanelCorpoLayout.createSequentialGroup()
                ...
                .addComponent(jLabelCorpoNotas)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneCorpoNotas, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(16, 16, 16))
        );
    ...
    private void jLabel2LogoIconMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jLabel2LogoIconMouseClicked
       ...
       try {
            ...
            if (jTextFieldCorpoNome.getText().equals("") || jFormattedTextFieldCorpoPrazo.getText().isEmpty()) {

                JOptionPane.showMessageDialog(rootPane,
                        "Tarefa não foi " + "salva! Preencha os campos Nome ou Prazo corretamente!");
            } else {
                Task task = new Task();
